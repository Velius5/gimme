...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    TextView logowanie_zapomniane_haslo;
    Button logowanie_zaloguj_button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emailTextView = (AutoCompleteTextView) findViewById(R.id.logowanie_wpiszLogin);
        loadAutoComplete();

        passwordTextView = (EditText) findViewById(R.id.logowanie_wpiszHaslo);
        ...
        logowanie_zaloguj_button= (Button) findViewById(R.id.logowanie_zaloguj_button);
        logowanie_zaloguj_button.setOnClickListener(new OnClickListener() {
            @Override
        ...
        logowanie_zapomniane_haslo = (TextView) findViewById(R.id.logowanie_zapomniane_haslo);
        logowanie_zapomniane_haslo.setOnClickListener(new View.OnClickListener() {
            @Override//link do przypomnienia hasla
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                passwordTextView.setError(getString(R.string.correct_password));
            } else {
                // login failure
...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    private TextView logowanie_zapomniane_haslo;
    Button logowanie_zaloguj_button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logowanie_zapomniane_haslo = (TextView) findViewById(R.id.logowanie_zapomniane_haslo);
        logowanie_zapomniane_haslo.setPaintFlags(logowanie_zapomniane_haslo.getPaintFlags() | Paint.UNDERLINE_TEXT_FLAG);
        Linkify.addLinks(logowanie_zapomniane_haslo, Linkify.ALL);

        logowanie_zapomniane_haslo.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
