...
*/
/* wersja z ładowanie obrazów z neta *//*
...
public class Gallery_Activity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.gallery_okno);
        ...
        try {
            for(int i = 0; i < 10; i++) {
                this.bitmapList.add(urlImageToBitmap("http://www.coreblog.pl/wp-content/uploads/2012/09/ikona_android.jpg"));
